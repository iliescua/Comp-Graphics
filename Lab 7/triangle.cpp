...
void triangle::draw(GraphicsContext* gc, ViewContext* vc) {
  ...
  matrix m2(4, 1);
  matrix m3(4, 1);
  m1 = vc->mTOd * this->pOne;
  m2 = vc->mTOd * this->pTwo;
  m3 = vc->mTOd * this->pThree;
  gc->drawLine(m1[0][0], m1[1][0], m2[0][0],
               m2[1][0]);
  gc->drawLine(m1[0][0], m1[1][0], m3[0][0],
               m3[1][0]);
  gc->drawLine(m2[0][0], m2[1][0], m3[0][0],
               m3[1][0]); 
}
...
void triangle::convertCoords(ViewContext* vc){
  this->pOne = vc->dTOm * this->pOne;
  this->pTwo = vc->dTOm * this->pTwo;
  this->pThree = vc->dTOm * this->pThree;
}